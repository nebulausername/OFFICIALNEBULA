...
export default function AdminLiveChat() {
    ...
    return (
        <div className="flex h-[calc(100vh-64px)] bg-zinc-950 text-white overflow-hidden relative">
            {/* Background Gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-purple-900/10 via-zinc-950 to-amber-900/10 pointer-events-none" />
            ...
            <motion.div
                ...
                className={`${selectedSessionId ? 'hidden md:flex' : 'flex'} w-full md:w-80 lg:w-96 flex-col glass border-r-0 border-r-white/5 z-10`}
            >
                <div className="p-4 border-b border-white/5 space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-xs px-2.5 py-1 bg-white/5 border border-white/10 rounded-full text-zinc-400 font-medium">
                            ...
                            {filteredSessions.map((session, i) => (
                                ...
                                >
                                    <div className="flex justify-between mb-1.5">
                                        <span className={`font-bold text-sm ${selectedSessionId === session.id ? 'text-purple-300' : 'text-zinc-200'}`}>
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        {session._count?.messages > 0 && (
                                            <motion.span
                                                initial={{ scale: 0 }}
                                                animate={{ scale: 1 }}
                                                className="flex items-center justify-center min-w-[1.25rem] h-5 px-1.5 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-full text-[10px] font-bold shadow-lg shadow-purple-500/30"
                                            >
            ...
            {/* Main Chat Area */}
            <div className={`${!selectedSessionId ? 'hidden md:flex' : 'flex'} flex-1 flex-col relative z-10`}>
                {selectedSessionId ? (
                    <>
                        {/* Chat Header */}
                        <div className="h-20 border-b border-white/5 flex items-center justify-between px-6 glass bg-zinc-900/40">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="relative">
                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-zinc-800 to-zinc-900 border border-white/10 flex items-center justify-center text-sm font-bold shadow-inner">
                                        <User className="w-5 h-5 text-zinc-400" />
                                    </div>
                                    <div className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-zinc-950 rounded-full animate-pulse shadow-[0_0_10px_rgba(34,197,94,0.5)]"></div>
                                </div>
                                <div>
                            ...
                            <div className="flex items-center gap-1 text-zinc-400">
                                ...
                                <Button size="icon" variant="ghost" className="hover:bg-white/5 hover:text-white rounded-xl transition-all"><Phone className="w-5 h-5" /></Button>
                                <Button size="icon" variant="ghost" className="hover:bg-white/5 hover:text-white rounded-xl transition-all"><MoreVertical className="w-5 h-5" /></Button>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-thin scrollbar-thumb-zinc-800 scrollbar-track-transparent">
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`max-w-[70%] group relative`}>
                                            <div className={`px-5 py-3.5 rounded-2xl shadow-lg backdrop-blur-sm border ${isMe
                                                ? 'bg-gradient-to-br from-purple-600 to-indigo-600 border-white/10 text-white rounded-tr-sm shadow-purple-900/20'
                                                : 'bg-zinc-800/60 border-white/10 text-zinc-100 rounded-tl-sm shadow-black/20'
                                                }`}>
                            ...
                            <AnimatePresence>
                                {otherUserTyping && (
                                    ...
                                    >
                                        <div className="bg-zinc-800/50 border border-white/10 px-4 py-3 rounded-2xl rounded-tl-sm flex gap-1.5 items-center backdrop-blur-sm">
                        ...
                        <div className="p-4 border-t border-white/5 glass bg-zinc-900/60">
                            <div className="flex items-center gap-3 bg-black/40 p-2 rounded-2xl border border-white/5 focus-within:border-purple-500/30 focus-within:ring-1 focus-within:ring-purple-500/20 transition-all shadow-inner">
                                ...
                                <input
                                    type="text"
                                    className="flex-1 bg-transparent border-none outline-none text-white text-sm px-2 placeholder:text-zinc-500 font-medium"
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-zinc-500 relative overflow-hidden">
                        <div className="w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-[120px] absolute pointer-events-none" />

                        <div className="relative z-10 text-center">
                            <div className="w-24 h-24 glass rounded-[2rem] flex items-center justify-center mx-auto mb-6 relative border border-white/10 shadow-2xl skew-y-3 transform rotate-3 hover:rotate-0 transition-transform duration-500 group cursor-default">
                                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-transparent rounded-[2rem] group-hover:from-purple-500/20" />
                                <MessageCircle className="w-10 h-10 text-purple-400/80 group-hover:scale-110 transition-transform" />
                                <div className="absolute -top-2 -right-2 w-8 h-8 bg-zinc-950 rounded-full flex items-center justify-center border border-white/10 shadow-lg">
                            ...
                            <h3 className="text-3xl font-black text-white mb-3 tracking-tight drop-shadow-lg">Nebula Commander</h3>
                            <p className="max-w-[320px] mx-auto text-sm leading-relaxed text-zinc-400">
                                Wähle eine Konversation aus der linken Leiste, um den <span className="text-purple-300 font-bold">Premium Support</span> zu starten.
                            </p>
                        </div>
                    </div>
                )}
