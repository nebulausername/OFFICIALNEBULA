...
export const DEMO_PRODUCTS = [
    {
        ...
        description: 'Premium Baumwolle T-Shirt mit Nebula Logo',
        price: 49.90,
        currency: 'EUR',
    ...
    },
    {
        ...
        description: 'Oversized Hoodie in Premium Qualität',
        price: 89.90,
        currency: 'EUR',
        cover_image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400',
        in_stock: true,
        product_type: 'clothing',
        tags: ['bestseller', 'new'],
        lead_time_days: 5,
    ...
    },
    {
        ...
        description: 'Premium Snapback mit gesticktem Logo',
        price: 34.90,
        currency: 'EUR',
        cover_image: 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=400',
        in_stock: true,
    ...
    },
    {
        ...
        description: 'Bequeme Jogginghose mit Nebula Branding',
        price: 69.90,
        currency: 'EUR',
        cover_image: 'https://images.unsplash.com/photo-1552902865-b72c031ac5ea?w=400',
        in_stock: true,
        product_type: 'clothing',
